...
<body>
    ...
    <ul id="slide-out" class="sidenav grey lighten-2">
        ...
        @endcan
        <li class="hide-on-large-only"><a class="btn grey lighten-3 waves-effect sidenav-menu-btn" href="{{ route('profile') }}"><i class="material-icons left">person</i>Perfil</a></li>
        <li class="sair-botao hide-on-large-only"><a class="btn grey lighten-3 waves-effect sidenav-menu-btn" href="{{ route('login.logout') }}"><i class="material-icons left">logout</i>Sair</a></li>
    </ul>
